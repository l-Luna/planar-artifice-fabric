...
public final class LocalAxis{
	...
	// Adapted from LookingPosArgument::toAbsolutePos
	public static Vec3d toAbsolutePos(Vec3d localPos, Vec2f rotation, Vec3d pos){
		...
		return new Vec3d(pos.x + xOff, pos.y + yOff, pos.z + zOff);
	}
}
